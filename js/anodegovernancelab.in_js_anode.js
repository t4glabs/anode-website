...
(function (a) {
    ...
    var n = {
        ...
        fallbackToMouseEvents: true, excludedElements: "label, button, input, select, textarea, a, .noSwipe",
    ...
    f.fn.swipe.phases = {PHASE_START: g, PHASE_MOVE: k,
        PHASE_END: h,
        PHASE_CANCEL: q
    };
...
/*About us Function*/
$(function () {
    $('#aboutusinner').on('hide.bs.collapse', function () {
        $('#readmore').html('<span class="label label-default">Read More <i class="fa fa-plus"></i></span>');
    })
    $('#aboutusinner').on('show.bs.collapse', function () {
        $('#readmore').html('<span class="label label-default">Read Less <i class="fa fa-minus"></i></span>');
    })
})

/*Team Function*/
$(function () {
    $('#sonaliinner').on('hide.bs.collapse', function () {
        $('#sonali').html('<span class="label label-default">Read More <i class="fa fa-plus"></i></span>');
    })
    $('#sonaliinner').on('show.bs.collapse', function () {
        $('#sonali').html('<span class="label label-default">Read Less <i class="fa fa-minus"></i></span>');
    })
})

$(function () {
    $('#anjaliinner').on('hide.bs.collapse', function () {
        $('#anjali').html('<span class="label label-default">Read More <i class="fa fa-plus"></i></span>');
    })
    $('#anjaliinner').on('show.bs.collapse', function () {
        $('#anjali').html('<span class="label label-default">Read Less <i class="fa fa-minus"></i></span>');
    })
})

$(function () {
    $('#hemantinner').on('hide.bs.collapse', function () {
        $('#hemant').html('<span class="label label-default">Read More <i class="fa fa-plus"></i></span>');
    })
    $('#hemantinner').on('show.bs.collapse', function () {
        $('#hemant').html('<span class="label label-default">Read Less <i class="fa fa-minus"></i></span>');
    })
})

$(function () {
    $('#divyainner').on('hide.bs.collapse', function () {
        $('#divya').html('<span class="label label-default">Read More <i class="fa fa-plus"></i></span>');
    })
    $('#divyainner').on('show.bs.collapse', function () {
        $('#divya').html('<span class="label label-default">Read Less <i class="fa fa-minus"></i></span>');
    })
})

$(function () {
    $('#shwethainner').on('hide.bs.collapse', function () {
        $('#shwetha').html('<span class="label label-default">Read More <i class="fa fa-plus"></i></span>');
    })
    $('#shwethainner').on('show.bs.collapse', function () {
        $('#shwetha').html('<span class="label label-default">Read Less <i class="fa fa-minus"></i></span>');
    })
})
...
/*$('#jkc').hide();
 ...
 $('#jk_ch').mouseover(function () {
 $('#jkc').show();
 });
 $('#jk_ch').mouseout(function () {
 $('#jkc').hide();
 });
 
 $('#jkp').hide();
 
 $('#jk_ph').mouseover(function () {
 $('#jkp').show();
 });
 $('#jk_ph').mouseout(function () {
 $('#jkp').hide();
 });
 ...
 $('#jk_bh').mouseover(function () {
 $('#jkb').show();
 });
 $('#jk_bh').mouseout(function () {
 $('#jkb').hide();
 });*/
...
/*$('#kcb').hide();
 ...
 $('#kch').mouseover(function () {
 $('#kcb').show();
 });
 $('#kch').mouseout(function () {
 $('#kcb').hide();
 });*/
...
/*
 ...
 $('#mp_sh').mouseover(function () {
 $('#mps').show();
 });
 $('#mp_sh').mouseout(function () {
 $('#mps').hide();
 });
 ...
 $('#mp_dh').mouseover(function () {
 $('#mpd').show();
 });
 $('#mp_dh').mouseout(function () {
 $('#mpd').hide();
 });
 */
...
function jkchide() {
    $('#jkc').removeClass('hide');
    $('#jkc').addClass('display_content');
    $('#jkp').addClass('hide');
    $('#jkb').addClass('hide');
    $('#kcb').addClass('hide');
    $('#mps').addClass('hide');
    $('#mpd').addClass('hide');
    $('#jk_boh').addClass('hide');
}
...
function jkphide() {
    $('#jkp').removeClass('hide');
    $('#jkp').addClass('display_content');
    $('#jkb').addClass('hide');
    $('#jkc').addClass('hide');
    $('#kcb').addClass('hide');
    $('#mps').addClass('hide');
...
function jkbhide() {
    $('#jkb').removeClass('hide');
    $('#jkb').addClass('display_content');
    $('#jkc').addClass('hide');
    $('#jkp').addClass('hide');
    $('#kcb').addClass('hide');
    $('#mps').addClass('hide');
...
function jkbokhide() {
    $('#jk_boh').removeClass('hide');
    $('#jk_boh').addClass('display_content');
    $('#jkb').addClass('hide');
    $('#jkc').addClass('hide');
    $('#jkp').addClass('hide');
    $('#kcb').addClass('hide');
...
function kchhide() {
    $('#kcb').removeClass('hide');
    $('#kcb').addClass('display_content');
    $('#jkc').addClass('hide');
    $('#jkp').addClass('hide');
    $('#jkb').addClass('hide');
    $('#mps').addClass('hide');
...
function mpdhide() {
    $('#mpd').removeClass('hide');
    $('#mpd').addClass('display_content');
    $('#jkc').addClass('hide');
    $('#jkp').addClass('hide');
    $('#jkb').addClass('hide');
    $('#kcb').addClass('hide');
...
function mahaarhide() {
    ...
    $('#mps').addClass('hide');
    $('#mahaa').addClass('hide');
    $('#mahaar').removeClass('hide');
    $('#jk_boh').addClass('hide');
}

function mahaarDiv() {
    $('#mahaar').addClass('hide');
}
